...
for (i = 0; i < product.length; i++) {
  ...
  for (var j in product[i]) {
    if(j=="preview"){
      ...
      img_tag.src = product[i][j]
      div_tag.append(img_tag);
   }
   if(j=="name"){
       var name1 = document.createElement("h4")
          name1.className= "p_tag"
          
          name1.innerHTML += `${product[i][j]}<br>`;
          div_tag.append(name1)
   }
   if(j=="brand"){
       var brand1 = document.createElement("p")
       brand1.className ="brand"
       brand1.innerHTML = `${product[i][j]}<br>`;
       div_tag.append(brand1)
   }
   if(j =="price"){
       var price1 = document.createElement("h2")
       price1.className ="price"
       price1.innerHTML = ` RS - ${product[i][j]}<br>`;
       price1.style.color ="green"
       div_tag.append(price1)
   }
    document.getElementById("demo11").appendChild(div_tag);
  }
}
...
for (i = 0; i < product2.length; i++) {
  var div_tag = document.createElement("div");
  div_tag.className = "div_style";
  for (var j in product2[i]) {
    if(j=="preview"){
      var img_tag = document.createElement('img');
      img_tag.className="img_img"
      img_tag.src = product2[i][j]
      div_tag.append(img_tag);
   }
   if(j=="name"){
       var name1 = document.createElement("h4")
          ...
          name1.innerHTML += `${product2[i][j]}<br>`;
          div_tag.append(name1)
   }
   if(j=="brand"){
       var brand1 = document.createElement("p")
       brand1.className ="brand"
       brand1.innerHTML = `${product2[i][j]}<br>`;
       div_tag.append(brand1)
   }
   if(j =="price"){
       var price1 = document.createElement("h2")
       price1.className ="price"
       price1.innerHTML = ` RS - ${product2[i][j]}<br>`;
       price1.style.color ="green"
       div_tag.append(price1)
   }
    document.getElementById("demo22").appendChild(div_tag);
  }
}
